...
export function NotificationChannelsContent({ user }: { user: UserContact }) {
    return (
...
export function NotificationChannelsPage({ layout, user }: { layout: LayoutName; user: UserContact }) {
    return (
        <LayoutResolved layout={layout} title="Notifications" currentUrl="/notifications">
            <NotificationChannelsContent user={user} />
        </LayoutResolved>
    );
}

export function DoNotDisturbContent({ digestItems }: { digestItems: DigestItem[] }) {
    return (
        <div className="p-6 max-w-2xl mx-auto space-y-6">
            <h1 className="text-xl font-semibold">Notifications</h1>
...
export function DoNotDisturbPage({ layout, digestItems }: { layout: LayoutName; digestItems: DigestItem[] }) {
    return (
        <LayoutResolved layout={layout} title="Notifications" currentUrl="/notifications">
            <DoNotDisturbContent digestItems={digestItems} />
        </LayoutResolved>
    );
}
