...
export function AssigneesTableContent({ assignees }: { assignees: Assignee[] }) {
...
export function AssigneesTablePage({ layout, assignees }: { layout: LayoutName; assignees: Assignee[] }) {
    return (
        <LayoutResolved layout={layout} title="Assignees" currentUrl="/assignees">
            <AssigneesTableContent assignees={assignees} />
        </LayoutResolved>
    );
}

export function AssigneesMapContent({
    assignees,
    devices = [],
}: {
    assignees: Assignee[];
...
export function AssigneesMapPage({
    ...
    return (
        <LayoutResolved layout={layout} title="Assignees — Map" currentUrl="/assignees/map">
            <AssigneesMapContent assignees={assignees} devices={devices} />
        </LayoutResolved>
    );
}
