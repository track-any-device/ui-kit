...
export function DashboardPage({
    ...
    return (
        <LayoutResolved layout={layout} title="Dashboard" currentUrl="/dashboard">
            <DashboardContent stats={stats} vehicles={vehicles} recentActivity={recentActivity} devices={devices} mapIncidents={mapIncidents} />
        </LayoutResolved>
    );
}
...
export function DashboardWithIncidentContent({
    stats,
    alert,
}: {
...
export function DashboardWithIncidentPage({
    ...
    return (
        <LayoutResolved layout={layout} title="Dashboard" currentUrl="/dashboard">
            <DashboardWithIncidentContent stats={stats} alert={alert} />
        </LayoutResolved>
    );
}
