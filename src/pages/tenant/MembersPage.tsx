...
export function TeamMembersContent({ members }: { members: Member[] }) {
...
export function RolesContent({ roles }: { roles: Role[] }) {
    return (
...
export function PermissionsToggleContent({ sections }: { sections: PermissionSection[] }) {
    return (
        <div className="p-6 max-w-4xl mx-auto space-y-6">
            <div className="flex items-center justify-between">
...
export function PermissionsTogglePage({ layout, sections }: { layout: LayoutName; sections: PermissionSection[] }) {
    return (
        <LayoutResolved layout={layout}>
            <PermissionsToggleContent sections={sections} />
        </LayoutResolved>
    );
}

export function TeamInfoContent({ members, roles }: { members: Member[]; roles: Role[] }) {
...
export function TeamInfoPage({ layout, members, roles }: { layout: LayoutName; members: Member[]; roles: Role[] }) {
    return (
        <LayoutResolved layout={layout}>
            <TeamInfoContent members={members} roles={roles} />
        </LayoutResolved>
    );
}
