...
import { default as AppearanceTabs } from '../../components/appearance-tabs';
...
export function UserProfileTabsContent({ user }: { user: TenantUser }) {
...
export function UserProfileTabsPage({ layout, user }: { layout: LayoutName; user: TenantUser }) {
    return (
        <LayoutResolved layout={layout} title="My Profile" currentUrl="/profile">
            <UserProfileTabsContent user={user} />
        </LayoutResolved>
    );
}

export function UserSettingsSidebarContent({ user, orgName }: { user: TenantUser; orgName: string }) {
...
export function UserSettingsSidebarPage({ layout, user, orgName }: {
    ...
    return (
        <LayoutResolved layout={layout} title="Settings" currentUrl="/settings/profile">
            <UserSettingsSidebarContent user={user} orgName={orgName} />
        </LayoutResolved>
    );
}

export function CompanyProfileContent({ org, members }: { org: TenantOrg; members: OrgMember[] }) {
    return (
...
export function CompanyProfilePage({ layout, org, members }: {
    ...
    return (
        <LayoutResolved layout={layout} title="Organisation" currentUrl="/settings/organisation">
            <CompanyProfileContent org={org} members={members} />
        </LayoutResolved>
    );
}

export function SecuritySettingsContent({ securityLog }: { securityLog: SecurityLogEntry[] }) {
    return (
...
export function SecuritySettingsPage({ layout, securityLog }: { layout: LayoutName; securityLog: SecurityLogEntry[] }) {
    return (
        <LayoutResolved layout={layout} title="Security" currentUrl="/settings/security">
            <SecuritySettingsContent securityLog={securityLog} />
        </LayoutResolved>
    );
}

export function TenantBillingContent({ org, invoices }: { org: TenantOrg; invoices: TenantInvoice[] }) {
    return (
        <div className="p-6 max-w-3xl space-y-6">
...
export function TenantBillingPage({ layout, org, invoices }: {
    ...
    return (
        <LayoutResolved layout={layout} title="Billing" currentUrl="/settings/billing">
            <TenantBillingContent org={org} invoices={invoices} />
        </LayoutResolved>
    );
}
